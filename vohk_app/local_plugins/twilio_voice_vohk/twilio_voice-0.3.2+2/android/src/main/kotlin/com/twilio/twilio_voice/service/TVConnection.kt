...
class TVCallInviteConnection(
    ...
    private val onShowIncomingCallUiRequested: (() -> Unit)? = null,
    ...
    override fun onShowIncomingCallUi() {
        ...
        Log.d(TAG, "onShowIncomingCallUi: requesting application call notification")
        onShowIncomingCallUiRequested?.invoke()
    }
